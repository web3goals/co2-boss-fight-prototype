export const hypercertsContractAbi = [
  { inputs: [], stateMutability: "nonpayable", type: "constructor" },
  { inputs: [], name: "AlreadyClaimed", type: "error" },
  { inputs: [], name: "ArraySize", type: "error" },
  ...
  { inputs: [], name: "TypeMismatch", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "_account", type: "address" },
      { internalType: "uint256[]", name: "_fractionIDs", type: "uint256[]" },
    ],
    name: "mergeFractions",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "_account", type: "address" },
      { internalType: "uint256", name: "_tokenID", type: "uint256" },
      { internalType: "uint256[]", name: "_newFractions", type: "uint256[]" },
    ],
    name: "splitFraction",
    outputs: [],
    stateMutability: "nonpayable",
